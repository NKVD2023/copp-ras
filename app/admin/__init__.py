...
from app.admin import routes_dashboard, routes_users, routes_templates, routes_constructor, routes_db, routes_files, routes_dictionaries, routes_departments, routes_db_stats