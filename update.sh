...
section "1/5  Получение обновлений с GitHub"
cd "$APP_DIR"
...
# ─── 2. ЗАВИСИМОСТИ ───────────────────────────────────────────────────────────
section "2/5  Зависимости Python"
...
if [ -f "$APP_DIR/add_users.py" ]; then
    info "Запуск скрипта add_users.py (обновление справочника)..."
...
# ─── 5. ПЕРЕЗАПУСК ────────────────────────────────────────────────────────────
section "5/5  Перезапуск сервисов"
